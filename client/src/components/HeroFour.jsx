import HeroFourr from "../assets/Rectangle13.svg";
const HeroFour = () => {
    return (
      <div className="bg-[#E7F9E9] px-5 py-12 lg:px-20 lg:py-32">
        <div className="flex flex-col lg:flex-row-reverse justify-between">
          ...
          <div className="w-full lg:w-[50%]">
            ...
            <h1 className="text-[35px] lg:text-[50px] font-extrabold dark:text-[#0C273D]">RPA and AI courses <br className="hidden lg:block" />for everyone</h1>
